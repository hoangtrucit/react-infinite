          ...
          (function(global) {
            ...
            var _createClass = (function() {
                function e(e, t) {
                  for (var o = 0; o < t.length; o++) {
                    var i = t[o];
                    (i.enumerable =
                      i.enumerable || !1), (i.configurable = !0), 'value' in
                      i && (i.writable = !0), Object.defineProperty(
                      e,
                      i.key,
                      i
                    );
            ...
            var scaleEnum = require('./utils/scaleEnum'),
              ...
              Infinite = (function(e) {
                function t(e) {
                  ...
                  _initialiseProps.call(o);
                  var i = o.recomputeInternalStateFromProps(e);
                  (o.computedProps = i.computedProps), (o.utils =
                    i.utils), (o.shouldAttachToBottom = e.displayBottomUpwards);
                  var n = i.newState;
                  return (n.scrollTimeout = void 0), (n.isScrolling = !1), (o.state = n), o;
                }
                return _inherits(t, e), _createClass(t, null, [
                  ...
                  },
                  {
                    ...
                    value: function() {
                      ...
                      var o = {};
                      this.state.isScrolling && (o.pointerEvents = 'none');
                      var i = this.state.infiniteComputer.getTopSpacerHeight(
                          this.state.displayIndexStart
                        ),
                      ...
                      if (this.computedProps.displayBottomUpwards) {
                        var r =
                          ...
                          this.state.infiniteComputer.getTotalScrollableHeight();
                        r > 0 && (i = r - this.loadingSpinnerHeight);
                      }
                      var s =
                        void 0 ===
                      ...
                      return React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement('div', {
                            ...
                            style: infiniteHelpers.buildHeightStyle(i)
                          }),
            ...
            var _initialiseProps = function() {
              ...
              (this.shouldAttachToBottom = !1), (this.preservedScrollState = 0), (this.loadingSpinnerHeight = 0), (this.generateComputedUtilityFunctions = function(
                ...
                var o = {};
                return (o.getLoadingSpinnerHeight = function() {
                  var t = 0;
                  ...
                  : (
                      (o.subscribeToScrollListener = function() {}),
                      (o.unsubscribeFromScrollListener = function() {}),
                      (o.nodeScrollListener = e.infiniteHandleScroll),
                      (o.getScrollTop = function() {
                        return e.scrollable ? e.scrollable.scrollTop : 0;
                      }),
                      (o.setScrollTop = function(t) {
                        e.scrollable && (e.scrollable.scrollTop = t);
                      }),
                      (o.scrollShouldBeIgnored = function(t) {
                ...
                checkProps(t);
                var o = infiniteHelpers.generateComputedProps(t),
                  i = e.generateComputedUtilityFunctions(t),
                  n = {};
                return (n.numberOfChildren = React.Children.count(
                  ...
                  o.elementHeight,
                  o.children
                )), void 0 !== o.isInfiniteLoading &&
                  (n.isInfiniteLoading =
                    o.isInfiniteLoading), (n.preloadBatchSize =
                  o.preloadBatchSize), (n.preloadAdditionalHeight =
                  o.preloadAdditionalHeight), (n = Object.assign(
                  n,
                  infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(
                    n,
                    i.getScrollTop()
                  )
                )), { computedProps: o, utils: i, newState: n };
                ...
                e.setState({ isScrolling: !0, scrollTimeout: o });
                ...
                var o = e.computedProps.infiniteLoadBeginEdgeOffset;
                return (
                  typeof o === 'number' &&
                  (e.computedProps.displayBottomUpwards
                    ? !e.shouldAttachToBottom && t < o
                    : t >
                      e.state.infiniteComputer.getTotalScrollableHeight() -
                        e.computedProps.containerHeight -
                        o)
                ...
                var o = infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(
                  e.state,
                  t
                );
                e.passedEdgeForInfiniteScroll(t) && !e.state.isInfiniteLoading
                  ? (e.setState(Object.assign({}, o)), e.onInfiniteLoad())
                  : e.setState(o);
              });
            };
